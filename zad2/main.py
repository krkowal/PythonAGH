...
def get_n_gram(file_path, n: int):
    gen = lines_generator(file_path)
    n_gram = {}
    current_line = []
    try:
...
if __name__ == '__main__':
    ...
    print(f"Words count: {words_lst}")
    print("Printing bigram and trigram")
    bigram_no = int(input("How many words of bigram do you wish to see?: "))
    print(f"Bigram: {get_items_from_ordered_list(get_n_gram('potop.txt', 2), bigram_no)}")
    trigram_no = int(input("How many words of trigram do you wish to see?: "))
